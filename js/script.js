...
const backroomsIndex = [
    ...
    { title: "Рівень 1", name: "Підземний блок", url: "/normal-pages/levels/level-1.html" },
    { title: "Рівень 2", name: "Технічний поверх", url: "/normal-pages/levels/level-2.html" },
    { title: "Рівень 3", name: "Електростанція", url: "/normal-pages/levels/level-3.html" },
    { title: "Рівень 4", name: "Офіси", url: "/normal-pages/levels/level-4.html" },
    { title: "Рівень 4/Список поверхів", name: "Список поверхів Рівня 4", url: "/normal-pages/level-4/floor-list.html" },
    { title: "Рівень 5", name: "Готель", url: "/normal-pages/levels/level-5.html" },
    { title: "Рівень 6", name: "Безодня", url: "/normal-pages/levels/level-6.html" },
    { title: "Рівень 7", name: "Океан", url: "/normal-pages/levels/level-7.html" },
    { title: "Рівень 8", name: "Печери", url: "/normal-pages/levels/level-8.html" },
    ...
    { title: "Об'єкт 7", name: "Сигарети LIFE", url: "/normal-pages/objects/object-7.html" },
    ...
    { title: "Сутність 6", name: "Паличник", url: "/normal-pages/entities/entity-6.html" },
    ...
    { title: "Цікаві знахідки", name: "Список знахідок", url: "/special-pages/interesting-findings.html" },
    { title: "Автори", name: "Список авторів", url: "/special-pages/authors.html" },
